...
const PhoneNumberInput = ({ className = '', onFocus, onBlur, form, label, width, rules, addonBefore, hideIcon, name = 'phoneNumber', placeholder, autoFocus }) => {
    ...
    return (_jsx(Form.Item, { rules: rules && [
            ...rules,
            {
                min: 17,
                message: ' ',
            },
        ], label: label, className: `phone-number-input ${className} ${isFocused ? 'focused' : ''}`, name: name, children: _jsx(Input, { id: 'phoneNumberInput', onChange: handleChange, ref: inputRef, onFocus: e => {
                beforeFocus();
            ...
            }, onBlur: beforeBlur, onKeyDown: handleKeyPress, addonBefore: hideIcon ? undefined : addonBefore || _jsx(IconCallCalling, { size: 20, color: '#A5A8AD' }), placeholder: placeholder }) }));
};
